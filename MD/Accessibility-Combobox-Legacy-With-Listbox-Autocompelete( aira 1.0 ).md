...
| Key                                    | Function                                                     |
| -------------------------------------- | ------------------------------------------------------------ |
| Down Arrow                             | 1. If the textbox is not empty and the listbox is displayed, moves visual focus to the first suggested value.<br/>2. If the textbox is empty and the listbox is not displayed, opens the listbox and moves visual focus to the first option.<br/><b>3. In both cases DOM focus remains on the textbox.</b> |
| Up Arrow                               | 1. If the textbox is not empty and the listbox is displayed, moves visual focus to the last suggested value.<br/>2. If the textbox is empty, first opens the listbox if it is not already displayed and then moves visual focus to the last option.<br/><b>3. In both cases DOM focus remains on the textbox.</b> |
...
| Key                  | Function                                                     |
| -------------------- | ------------------------------------------------------------ |
| Enter                | 1. Sets the textbox value to the content of the focused option in the listbox.<br/>2. Closes the listbox.Sets visual focus on the textbox. |
| Escape               | 1. Clears the textbox.<br/>2. Closes the listbox.<br/>3. Sets visual focus on the textbox. |
| Down Arrow           | 1. Moves visual focus to the next option.<br/>2. If visual focus is on the last option, moves visual focus to the first option.<br/>3. Note: This wrapping behavior is useful when `Home` and `End` move the editing cursor as described below. |
| Up Arrow             | 1. Moves visual focus to the previous option.<br/>2. If visual focus is on the first option, moves visual focus to the last option.<br/>Note: This wrapping behavior is useful when Home and End move the editing cursor as described below. |
